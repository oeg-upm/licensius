...
public class LicenseFindlicenseintxt extends HttpServlet {
    ...
    public void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
            String uri = req.getParameter("txt");
            LicenseFinder lf = new LicenseFinder();
            LicensiusResponse le = lf.findLicenseInText(uri);
    ...
    public static void main(String[] args) {
        ...
        /*String x = LicenseGuess.guessLicense(uri);
        System.out.println(x);
        
        String s = RDFLicenseDataset.getRDFLicenseByLicense(x);
