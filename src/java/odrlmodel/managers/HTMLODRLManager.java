...
public class HTMLODRLManager {
    ...
    public static void main(String[] args) {
        ...
        body.appendText("<p>This is a text</p>");
     ...
     * @return HTML String
     */
    public static String htmlPolicyDEPRECATED(Policy p, String lan) {
        String s = "";
        Html html = new Html();
        Head head = new Head();
        Title title = new Title();
        ...
        s += "<hr/><img src=\"/ldc/img/rdf24.png\"/><small>View <a type=\"text/turtle\" href=\"" + p.getURI() + ".ttl\">license in RDF</a></small>";
        s += "</div>";
        s += "<br/><!--TEMPLATEHERE1-->";
