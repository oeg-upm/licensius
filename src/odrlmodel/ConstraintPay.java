...
//    public String toString()
//    {
/*        if (label.equals("Pay") || action.equals("http://www.w3.org/ns/odrl/2/pay"))
        {
            String pago = String.format(" Pay %.2f %s", amount, currency);
            label += " (" + pago+ ")";
        }
        
        boolean unit=isPerTriple();
        if (unit)
            label+=" - per unit";
        return label;*/
 //       return "";
 //   }
    ...
    public String getPriceString()
    {
        ...
        if (slabel.equals("Pay") || action.equals("http://www.w3.org/ns/odrl/2/pay"))
        {
