...
//        String test[]={"-i", "data/lexvo.rdf", "-o", "data/lexvo2.rdf", "-a", "ccby"};args=test;
    ...
    public static void initLogger() {
        ...
        try {
            ...
            Logger.getLogger("licenser").addAppender(appender);
            Logger.getLogger("licenser").addAppender(cappender);
        }catch(Exception e) {e.printStackTrace();}
        Logger.getLogger("licenser").setLevel((Level) Level.DEBUG);
        Logger.getLogger("licenser").info("Ejecutado: " + new Date().toString() + " - Iniciando logger");
        Logger.getLogger("licenser").info("=========================================================");
...
//        BasicConfigurator.configure();
        ...
        Logger.getLogger("licenser").info("Internet connection " + vroddon.system.InformacionSistema.hasInternetConnection());
    }
}
